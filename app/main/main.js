    ...
    function Controller($scope, $rootScope, $state, UserService, ModulesService, $window) {
        ...
        var introTour = new Tour({
            ...
            template: "<div class='popover tour-tour fight right in'>"+
                ...
                "</div>"+
            "</div>",
            //template: "<div class='popover tour'><div class='arrow'></div><div class='popover-content'></div><div class='popover-navigation'><button class='btn btn-default' data-role='prev'>�� Prev</button><span data-role='separator'>|</span><button class='btn btn-default' data-role='next'>Next ��</button></div><button class='btn btn-default' data-role='end'>End tour</button></div>",
            onEnd: function (tour) { 
